...
# 68 "c/linked_list.c"
int compare (field_type a, field_type b)
{
    return (a-b)*sorting;
}
# 81 "c/linked_list.c"
...
# 86 "c/linked_list.c"
    ...
    while ((p->next != 
# 90 "c/linked_list.c" 3 4
                      ((void *)0)
# 90 "c/linked_list.c"
                          ) && compare (value , p->next->elmt)>=0){
        prev=p;
        p=p->next;
    }
    if (p==
# 94 "c/linked_list.c" 3 4
          ((void *)0)
# 94 "c/linked_list.c"
              ){
